...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "image/jpeg", "image/jpg", "image/png", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for hr-documents" ON storage.objects FOR SELECT USING (bucket_id = 'hr-documents');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for hr-documents" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'hr-documents');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for hr-documents" ON storage.objects FOR UPDATE USING (bucket_id = 'hr-documents');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for hr-documents" ON storage.objects FOR DELETE USING (bucket_id = 'hr-documents');`
    ];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'hr-documents',
        public: true,
        allowed_mime_types: ["application/pdf", "image/jpeg", "image/jpg", "image/png", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"],
