...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Upload for employee-documents" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'employee-documents');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for employee-documents" ON storage.objects FOR UPDATE USING (bucket_id = 'employee-documents');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for employee-documents" ON storage.objects FOR DELETE USING (bucket_id = 'employee-documents');`
    ];
