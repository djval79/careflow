...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for applicant-cvs" ON storage.objects FOR SELECT USING (bucket_id = 'applicant-cvs');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for applicant-cvs" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'applicant-cvs');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for applicant-cvs" ON storage.objects FOR UPDATE USING (bucket_id = 'applicant-cvs');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for applicant-cvs" ON storage.objects FOR DELETE USING (bucket_id = 'applicant-cvs');`
    ];
