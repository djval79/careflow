-- ============================================================================
-- SIMPLE MIGRATION - CREATE ALL MISSING TABLES
-- ============================================================================
-- This creates all missing tables with NO foreign key constraints
...
-- CREATE POLICIES (Simple - allow all authenticated users)
DO $$ 
BEGIN
    -- Employees
...
SELECT 'Shifts created: ' || COUNT(*)::text as shifts_count FROM shifts;
