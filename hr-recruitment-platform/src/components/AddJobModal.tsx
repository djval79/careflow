...
export default function AddJobModal({ isOpen, onClose, onSuccess, onError }: AddJobModalProps) {
  const { user } = useAuth();
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Create Job Posting" maxWidth="max-w-4xl">
