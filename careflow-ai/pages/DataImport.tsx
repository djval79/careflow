...
const DataImport: React.FC = () => {
  ...
  const handleUpload = async () => {
    ...
    const mockRows = [
      ...
      "John Smith, john@careflow.com, Carer, 07700900123",
      "Sarah Jones, sarah.j, Senior, 0123456", // Error row
      "David Black, david@careflow.com, Nurse, 07700900999"
    ];

    try {
      const result = await validateImportData(mockRows);
  ...
  const renderSuccess = () => (
    <div className="max-w-md mx-auto text-center py-12 animate-in zoom-in duration-300">
       ...
       <p className="text-slate-500 mb-8">
          Successfully imported records. You can now view them in the People directory.
       </p>
       <button 
         onClick={reset}
